...
Public Class NotaReservation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel.NotaReservation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNotaReservation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NotaReservation = New NotaReservation()
        rpt.Site = Me.Site
        Return rpt
    End Function
